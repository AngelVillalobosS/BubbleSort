...
def test_sorting():
    sizes = [100000]  # Lista de tamaños a probar (usamos tamaños pequeños para mostrar los datos)
    for size in sizes:
        arr = [random.randint(0, 100000) for _ in range(size)]  # Genera una lista de números aleatorios
